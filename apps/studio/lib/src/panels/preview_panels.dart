...
/// Dockable Stitch Simulation panel: play/scrub the digitized sequence
/// with live stats. Vertical layout sized for the right dock.
...
/// Dockable Hoop panel: read-only hoop/fabric summary with a shape
/// preview; edits go through Document Setup.
class HoopPanelContent extends StatelessWidget {
  const HoopPanelContent({super.key, required this.hoop, required this.onEdit});
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          _row('Size',
              _value('${hoop.widthMm.round()} × ${hoop.heightMm.round()} mm')),
          _row(
            'Fabric',
