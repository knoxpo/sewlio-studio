...
This document defines the artwork analyzer architecture for Sewlio Studio's AI platform.
...
- Provide artwork structure detection
- Provide vector/raster interpretation
- Provide complexity assessment
- Provide pre-digitizing summaries

---

# Definition

Artwork Analyzer is the AI subsystem responsible for artwork structure detection and vector/raster interpretation.
...
- Manage artwork analyzer behavior through versioned prompts, typed tool contracts, governed context, and observable execution.
...
The artwork analyzer implementation should explicitly expose each stage for testing, observability, and human review.
...
- The artwork analyzer capability can be implemented within the documented AI runtime and command governance model.
