...
This document defines the context management architecture for Sewlio Studio's AI platform.
...
- Provide context budgeting
- Provide document-grounded retrieval
- Provide task scoping
- Provide redaction rules

---

# Definition

Context Management is the AI subsystem responsible for context budgeting and document-grounded retrieval.
...
- Manage context management behavior through versioned prompts, typed tool contracts, governed context, and observable execution.
...
The context management implementation should explicitly expose each stage for testing, observability, and human review.
...
- The context management capability can be implemented within the documented AI runtime and command governance model.
