...
This document defines the learning assistant architecture for Sewlio Studio's AI platform.
...
- Provide training workflows
- Provide skill-building guidance
- Provide contextual tutorials
- Provide domain-safe examples

---

# Definition

Learning Assistant is the AI subsystem responsible for training workflows and skill-building guidance.
...
- Manage learning assistant behavior through versioned prompts, typed tool contracts, governed context, and observable execution.
...
The learning assistant implementation should explicitly expose each stage for testing, observability, and human review.
...
- The learning assistant capability can be implemented within the documented AI runtime and command governance model.
