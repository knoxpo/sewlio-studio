...
This document defines the manufacturing agent architecture for Sewlio Studio's AI platform.
...
- Provide production preparation workflows
- Provide machine/material compatibility
- Provide handoff bundles
- Provide sign-off readiness

---

# Definition

Manufacturing Agent is the AI subsystem responsible for production preparation workflows and machine/material compatibility.
...
- Manage manufacturing agent behavior through versioned prompts, typed tool contracts, governed context, and observable execution.
...
The manufacturing agent implementation should explicitly expose each stage for testing, observability, and human review.
...
- The manufacturing agent capability can be implemented within the documented AI runtime and command governance model.
