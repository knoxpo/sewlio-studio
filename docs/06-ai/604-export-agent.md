...
This document defines the export agent architecture for Sewlio Studio's AI platform.
...
- Provide export preparation workflows
- Provide capability checks
- Provide artifact assembly
- Provide operator confirmation

---

# Definition

Export Agent is the AI subsystem responsible for export preparation workflows and capability checks.
...
- Manage export agent behavior through versioned prompts, typed tool contracts, governed context, and observable execution.
...
The export agent implementation should explicitly expose each stage for testing, observability, and human review.
...
- The export agent capability can be implemented within the documented AI runtime and command governance model.
