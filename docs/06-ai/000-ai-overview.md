...
AI Overview is the AI subsystem responsible for AI system boundaries and knowledge-driven reasoning.
...
The ai overview implementation should explicitly expose each stage for testing, observability, and human review.
...
- The ai overview capability can be implemented within the documented AI runtime and command governance model.
