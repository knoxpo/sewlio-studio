...
This document defines the tool calling architecture for Sewlio Studio's AI platform.
...
- Provide typed tool contracts
- Provide permission-aware execution
- Provide command gating
- Provide traceable actions

---

# Definition

Tool Calling is the AI subsystem responsible for typed tool contracts and permission-aware execution.
...
- Manage tool calling behavior through versioned prompts, typed tool contracts, governed context, and observable execution.
...
The tool calling implementation should explicitly expose each stage for testing, observability, and human review.
...
- The tool calling capability can be implemented within the documented AI runtime and command governance model.
