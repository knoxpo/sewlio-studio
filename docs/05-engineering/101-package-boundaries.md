...
Engineering decisions for package boundaries must preserve local-first behavior, command-driven mutation, event-derived updates, and scheduler-owned background work.
...
- Establish acyclic dependencies
- Establish public API discipline
- Establish domain isolation
- Establish testable seams

---

# Definition

Package Boundaries is the engineering subsystem or policy area that governs acyclic dependencies and public API discipline.
...
- Define package-level and service-level contracts for package boundaries.
...
The package boundaries implementation must fit within this layered model so that behavior remains testable and inspectable.
...
- The package boundaries guidance can be implemented without contradicting the documented architecture.
