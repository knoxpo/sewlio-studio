...
This document defines how file i/o should be implemented in Sewlio Studio.
...
Engineering decisions for file i/o must preserve local-first behavior, command-driven mutation, event-derived updates, and scheduler-owned background work.
...
- Establish streaming reads and writes
- Establish failure-safe saves
- Establish adapter boundaries
- Establish observable progress

---

# Definition

File I/O is the engineering subsystem or policy area that governs streaming reads and writes and failure-safe saves.
...
- Define package-level and service-level contracts for file i/o.
...
The file i/o implementation must fit within this layered model so that behavior remains testable and inspectable.
...
- The file i/o guidance can be implemented without contradicting the documented architecture.
