# Engineering
## ENG-800 Performance Engineering
...
This document defines how performance engineering should be implemented in Sewlio Studio.
...
Engineering decisions for performance engineering must preserve local-first behavior, command-driven mutation, event-derived updates, and scheduler-owned background work.
...
- Establish budget-driven design
- Establish measure-before-optimize
- Establish incremental recompute
- Establish backpressure

---

# Definition

Performance Engineering is the engineering subsystem or policy area that governs budget-driven design and measure-before-optimize.
...
- Define package-level and service-level contracts for performance engineering.
...
The performance engineering implementation must fit within this layered model so that behavior remains testable and inspectable.
...
- The performance engineering guidance can be implemented without contradicting the documented architecture.
