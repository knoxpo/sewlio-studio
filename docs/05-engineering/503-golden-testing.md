...
This document defines how golden testing should be implemented in Sewlio Studio.
...
Engineering decisions for golden testing must preserve local-first behavior, command-driven mutation, event-derived updates, and scheduler-owned background work.
...
- Establish visual and serialization goldens
- Establish reviewable diffs
- Establish approval workflow
- Establish cross-platform stability

---

# Definition

Golden Testing is the engineering subsystem or policy area that governs visual and serialization goldens and reviewable diffs.
...
- Define package-level and service-level contracts for golden testing.
...
The golden testing implementation must fit within this layered model so that behavior remains testable and inspectable.
...
- The golden testing guidance can be implemented without contradicting the documented architecture.
