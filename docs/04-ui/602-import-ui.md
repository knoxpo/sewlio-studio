...
This document defines the import ui architecture for Sewlio Studio.
...
The import ui is command-driven and state-derived.
...
- Provide preview and diagnostics
- Provide command-gated import

---

# Definition

Import UI is the UI subsystem responsible for exposing format selection and normalization options to end users.
...
- Render import ui state using deterministic projections from the document model and runtime services.
...
The import ui participates in this loop without bypassing command validation, event propagation, or scheduler-owned background work.
...
- Plugin-specific extensions for import ui.
...
- The import ui surface can be implemented without introducing direct domain mutations from UI code.
