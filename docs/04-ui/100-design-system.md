...
This document defines the design system architecture for Sewlio Studio.
...
The design system is command-driven and state-derived.
...
- Provide visual tokens
- Provide component contracts
- Provide semantic naming
- Provide platform consistency

---

# Definition

Design System is the UI subsystem responsible for exposing visual tokens and component contracts to end users.
...
- Render design system state using deterministic projections from the document model and runtime services.
...
The design system participates in this loop without bypassing command validation, event propagation, or scheduler-owned background work.
...
- Plugin-specific extensions for design system.
...
- The design system surface can be implemented without introducing direct domain mutations from UI code.
