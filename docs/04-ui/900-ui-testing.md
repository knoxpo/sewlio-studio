...
This document defines the ui testing architecture for Sewlio Studio.
...
The ui testing is command-driven and state-derived.
...
- Provide visual regression
- Provide interaction testing
- Provide accessibility verification
- Provide cross-platform determinism

---

# Definition

UI Testing is the UI subsystem responsible for exposing visual regression and interaction testing to end users.
...
- Render ui testing state using deterministic projections from the document model and runtime services.
...
The ui testing participates in this loop without bypassing command validation, event propagation, or scheduler-owned background work.
...
- Plugin-specific extensions for ui testing.
...
- The ui testing surface can be implemented without introducing direct domain mutations from UI code.
