...
This document defines the material panel architecture for Sewlio Studio.
...
The material panel is command-driven and state-derived.
...
- Provide fabric and stabilizer profiles
- Provide material assumptions
- Provide simulation impact visibility
- Provide digitizing hints

---

# Definition

Material Panel is the UI subsystem responsible for exposing fabric and stabilizer profiles and material assumptions to end users.
...
- Render material panel state using deterministic projections from the document model and runtime services.
...
The material panel participates in this loop without bypassing command validation, event propagation, or scheduler-owned background work.
...
- Plugin-specific extensions for material panel.
...
- The material panel surface can be implemented without introducing direct domain mutations from UI code.
