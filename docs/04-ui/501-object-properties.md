...
This document defines the object properties architecture for Sewlio Studio.
...
The object properties is command-driven and state-derived.
...
- Provide geometry properties
- Provide stitch properties
- Provide machine-affecting metadata
- Provide derived read-only fields

---

# Definition

Object Properties is the UI subsystem responsible for exposing geometry properties and stitch properties to end users.
...
- Render object properties state using deterministic projections from the document model and runtime services.
...
The object properties participates in this loop without bypassing command validation, event propagation, or scheduler-owned background work.
...
- Plugin-specific extensions for object properties.
...
- The object properties surface can be implemented without introducing direct domain mutations from UI code.
