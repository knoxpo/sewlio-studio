# UI
## UI-701 Quality Inspector UI

**Document ID:** UI-701  
**Title:** Quality Inspector UI  
**Version:** 1.0.0  
...
This document defines the quality inspector ui architecture for Sewlio Studio.
...
The quality inspector ui is command-driven and state-derived.
...
- Provide risk dashboards
- Provide issue navigation
- Provide explanations
- Provide fix proposal entry points

---

# Definition

Quality Inspector UI is the UI subsystem responsible for exposing risk dashboards and issue navigation to end users.
...
- Render quality inspector ui state using deterministic projections from the document model and runtime services.
...
The quality inspector ui participates in this loop without bypassing command validation, event propagation, or scheduler-owned background work.
...
- Plugin-specific extensions for quality inspector ui.
...
- The quality inspector ui surface can be implemented without introducing direct domain mutations from UI code.
