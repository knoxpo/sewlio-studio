...
The property inspector is command-driven and state-derived.
...
- Provide selection-derived forms
- Provide typed editors
- Provide validation feedback
- Provide declarative property grouping

---

# Definition

Property Inspector is the UI subsystem responsible for exposing selection-derived forms and typed editors to end users.
...
The property inspector participates in this loop without bypassing command validation, event propagation, or scheduler-owned background work.
...
- Plugin-specific extensions for property inspector.
...
- The property inspector surface can be implemented without introducing direct domain mutations from UI code.
