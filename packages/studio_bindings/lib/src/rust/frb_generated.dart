...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  String crateApiSimpleAppVersion() {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiSimpleAppVersionConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiSimpleAppVersionConstMeta => const TaskConstMeta(
  ...
  double crateApiSimpleDistance(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiSimpleDistanceConstMeta,
      argValues: [x1, y1, x2, y2],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiSimpleDistanceConstMeta => const TaskConstMeta(
        debugName: "distance",
